...
import { getPosts, getPostById, getAllPostByUserId, tambahPost, updatePost, editPostCategory, deletePost, getAllPostByCategoryId } from '../controllers/PostController.js';
...
router.post('/post', isUser, tambahPost);
