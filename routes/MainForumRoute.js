...
import { getMainForum, getAllMainForum, getMainForumById, tambahMainForum, updateMainForum, deleteMainForum } from '../controllers/MainForumController.js';
...
router.get('/mainAll', getAllMainForum); //route ini public dan memanggil fungsi dari MainForumController untuk menampilkan semua MainForum
